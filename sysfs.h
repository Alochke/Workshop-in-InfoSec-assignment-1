...
#define SUCCESS 0
#define SHOW_BYTES 2 * sizeof(unsigned int) // Number of bytes transferd inside the display function in sysfs.c from kernel space to user-space.
#define STORE_BYTES 0 // Number of bytes transferd inside the store function in sysfs.c from kernel space to user-space.
